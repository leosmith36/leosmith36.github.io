<template>
  <div>
    <footer class="flex items-center justify-between bg-stone-900 mx-auto p-3">
      <span class="text-sm">
        Developed by Leo Smith using Vue.js. Source code available
        <a href="https://github.com/leosmith36/leosmith36.github.io"> here</a>.
      </span>
